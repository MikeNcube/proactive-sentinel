...
- :mod:`soc.dlp`  --- DLP scanner INTERFACE STUB ONLY. Priority 1 work
  is parked; production implementation per canonical spec section 6
  is not yet present. See ``soc/dlp/__init__.py``.

Future subpackages (placeholders, not yet implemented):
- ``soc.policy``   --- OPA policy client (canonical spec section 7)
- ``soc.decision`` --- Decision Engine (canonical spec section 8)
